...
?>
		...
		<form action="<?php echo WP_PLUGIN_URL;?>/breezingforms/joomla-platform/administrator/components/com_breezingforms/admin/download.php" method="post" name="dldform">
