...
class QuickModeHtml{
	...
	public static function showApplication($formId = 0, $formName, $formTitle, $formDesc, $formEmailntf, $formEmailadr, $dataObjectString, $elementScripts, $themes){
		...
		$iconBase = '../wp-content/plugins/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/jquery/themes/quickmode/i/';
                $iconBaseWp = BF_PLUGINS_URL . '/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/jquery/themes/quickmode/i/';
?>              
	...
	<link rel="stylesheet" type="text/css" href="<?php echo WP_PLUGIN_URL;?>/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/jquery/themes/quickmode/quickmode.all.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo WP_PLUGIN_URL;?>/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/jquery/jtree/tree_component.css" />
        
        <script type="text/javascript" src="<?php echo WP_PLUGIN_URL . '/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/jquery/jtree/' ;?>_lib.js"></script>	
	<script type="text/javascript" src="<?php echo WP_PLUGIN_URL . '/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/jquery/jtree/' ;?>tree_component.js"></script>
	<script
	type="text/javascript"
	src="<?php echo WP_PLUGIN_URL . '/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/jquery/' ;?>jq-ui.min.js"></script>
	<script
	type="text/javascript"
	src="<?php echo WP_PLUGIN_URL . '/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/jquery/plugins/' ;?>base64.js"></script>
	<script
	type="text/javascript"
	src="<?php echo WP_PLUGIN_URL . '/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/jquery/plugins/' ;?>json.js"></script>
	<script
	type="text/javascript"
	src="<?php echo WP_PLUGIN_URL . '/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/jquery/plugins/' ;?>md5.js"></script>
        <script
	type="text/javascript"
	src="<?php echo WP_PLUGIN_URL;?>/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/jquery/center.js"></script>
