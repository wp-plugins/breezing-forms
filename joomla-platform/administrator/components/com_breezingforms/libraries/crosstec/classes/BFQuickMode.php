...
class BFQuickMode{
        ...
        public function fetchFoot($head)
	{
		...
		{
                        if(JURI::root(true) != ''){
                            $strSrc = str_replace(JURI::root(true), BF_PLUGINS_URL . '/breezingforms/joomla-platform/', $strSrc);
                        }else{
                            $strSrc = BF_PLUGINS_URL . '/breezingforms/joomla-platform/' . $strSrc;
                        }
...
display:none;
                ...
                $this->addStyleSheet( BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/libraries/jquery/tooltip.css' );
                $this->addScript(BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/libraries/jquery/tooltip.js');

                if($this->useBalloonErrors){
                    $this->addStyleSheet( BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/libraries/jquery/validationEngine.jquery.css' );
                    $this->addScript(BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/libraries/jquery/jquery.validationEngine-en.js');
                    $this->addScript(BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/libraries/jquery/jquery.validationEngine.js');
                }
...
');
		...
		');
		// loading system css
		$this->addStyleSheet( BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/themes/quickmode/system.css' );
		
                if(method_exists($obj = JFactory::getDocument(), 'addCustomTag')){
                
                    $stylelink = '<!--[if IE 7]>' ."\n";
                    $stylelink .= '<link rel="stylesheet" href="'.BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/themes/quickmode/system.ie7.css" />' ."\n";
                    $stylelink .= '<![endif]-->' ."\n";
                    $this->addCustomTag($stylelink);

                    $stylelink = '<!--[if IE 6]>' ."\n";
                    $stylelink .= '<link rel="stylesheet" href="'.BF_PLUGINS_URL . '/breezingforms/joomla-platformc/omponents/com_breezingforms/themes/quickmode/system.ie6.css" />' ."\n";
                    $stylelink .= '<![endif]-->' ."\n";
                    $this->addCustomTag($stylelink);

                    $stylelink = '<!--[if IE]>' ."\n";
                    $stylelink .= '<link rel="stylesheet" href="'.BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/themes/quickmode/system.ie.css" />' ."\n";
                    $stylelink .= '<![endif]-->' ."\n";
                    $this->addCustomTag($stylelink);
                }
				...
				switch($mdata['bfType']){
					...
					case 'bfFile':
						...
						if(isset( $mdata['flashUploader'] ) && $mdata['flashUploader']){
							...
							var bfFlashFileQueue".$mdata['dbId']." = {};
									...
									'uploader'       : '".BF_PLUGINS_URL . "/breezingforms/joomla-platform/components/com_breezingforms/libraries/jquery/uploadify.swf',
					...
					case 'bfCaptcha':
                                                ...
                                                if(JFactory::getApplication()->isSite())
                                                 {
                                                    $captcha_url = BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/images/captcha/securimage_show.php';
                                                 }
                                                 else
                                                 {
                                                    $captcha_url = BF_PLUGINS_URL . '/breezingforms/joomla-platform/administrator/components/com_breezingforms/images/captcha/securimage_show.php';
                                                 }
						...
						echo '<a href="#" class="ff_elem" onclick="document.getElementById(\'bfCaptchaEntry\').value=\'\';document.getElementById(\'bfCaptchaEntry\').focus();document.getElementById(\'ff_capimgValue\').src = \''.$captcha_url.'?bfMathRandom=\' + Math.random(); return false"><img alt="captcha" src="'.BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/images/captcha/refresh-captcha.png" border="0" /></a>'."\n";
						echo '</span>'."\n";
	...
	public function render(){
		...
		echo '</div>'."\n"; // closing last page
			...
			$this->addScript(BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/libraries/jquery/swfobject.js');
			$this->addScript(BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/libraries/jquery/jquery.uploadify.v2.1.0.min.js');
			$this->addScript(BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/libraries/jquery/center.js');
			$this->addScriptDeclaration('
