...
// script2clause
    ...
    function loadBuiltins(&$library) {
        ...
        $code .= 'if(error != "" && document.getElementById(\'ff_capimgValue\')){
                 document.getElementById(\'ff_capimgValue\').src = \'' . BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/images/captcha/securimage_show.php?bfMathRandom=\' + Math.random();
...
// addFunction
    ...
    function header() {
        ...
        '//-->' . nl() .
        '</script>' . nl() .
        '<script type="text/javascript" src="' . BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/facileforms.js"></script>' . nl();
    }
...
// header
    ...
    function view() {
        ...
        if ($this->runmode == _FF_RUNMODE_PREVIEW) {
            echo '<script type="text/javascript" src="' . BF_PLUGINS_URL . '/breezingforms/joomla-platform/administrator/components/com_breezingforms/libraries/wz_dragdrop/wz_dragdrop.js"></script>';
        }
            ...
            for ($i = 0; $i < $this->rowcount; $i++) {
                ...
                switch ($row->type) {
                    ...
                    case 'Captcha':
                        ...
                        //echo '<br/>';
                        echo '<a href="#" onclick="document.getElementById(\'bfCaptchaEntry\').value=\'\';document.getElementById(\'bfCaptchaEntry\').focus();document.getElementById(\'ff_capimgValue\').src = \'' . $captcha_url . '?bfCaptcha=true&bfMathRandom=\' + Math.random(); return false"><img src="' . BF_PLUGINS_URL . '/breezingforms/joomla-platform/components/com_breezingforms/images/captcha/refresh-captcha.png" border="0" /></a>';
                        echo indentc(1) . '</div>' . nl();
                        break;
                    case 'Query List':
                        echo indentc(1) . '<div id="ff_div' . $row->id . '" style="' . $attribs . '"' . $class1 . '>' . nlc();
