...
{
	public static function edit($option, $tabpane, $pkg, $ids, $caller)
	{
		global $database;
	...
	public static function save($option, $pkg, $caller, $nonclassic, $quickmode)
	{
		global $database;
		$database = JFactory::getDBO();
		$row = new facileFormsForms($database);
	...
	public static function cancel($option, $pkg, $caller)
	{
		if (trim($caller) == '') $caller = "admin.php?page=breezingforms&act=manageforms&pkg=$pkg";
	...
	public static function order($option, $pkg, $ids, $inc)
	{
		global $database;
		$database = JFactory::getDBO();
		$row = new facileFormsForms($database);
