...
{
	public static function edit($option, $tabpane, $pkg, $form, $page, $ids, $newtype)
	{
		global $database;
	...
	public static function newElement($option, $pkg, $form, $page)
	{
		HTML_facileFormsElement::newitem($option, $pkg, $form, $page);
	} // newElement

	public static function save($option, $pkg, $form, $page)
	{
		global $database;
		$database = JFactory::getDBO();
		$row = new facileFormsElements($database);
	...
	public static function cancel($option, $pkg, $form, $page)
	{
		JFactory::getApplication()->redirect("index.php?option=$option&act=editpage&form=$form&page=$page&pkg=$pkg");
	} // cancel

	public static function del($option, $pkg, $form, $page, $ids)
	{
		global $database;
		$database = JFactory::getDBO();
		$ids = implode(',', $ids);
	...
	public static function getDestination($option, $pkg, $form, $page, $ids, $action)
	{
		global $database;
		$database = JFactory::getDBO();
		$fff = array();
	...
	public static function copy($option, $pkg, $form, $page, $ids)
	{
		global $database;
		$database = JFactory::getDBO();
	...
	public static function move($option, $pkg, $form, $page, $ids)
	{
		global $database;
		$database = JFactory::getDBO();
		$destination = explode( ',', JRequest::getVar('destination',''));
	...
	public static function sort($option, $pkg, $form, $page)
	{
	...
	public static function movePos($option, $pkg, $form, $page, $ids, $task)
	{
	...
	public static function gridshow($option, $pkg, $form, $page, $ids, $task)
	{
		global $ff_config, $database;
		$database = JFactory::getDBO();
	...
	public static function publish($option, $pkg, $form, $page, $ids, $publish)
	{
		global $database, $my;
		$database = JFactory::getDBO();
		$ids = implode( ',', $ids );
	...
	public static function order($option, $pkg, $form, $page, $ids, $inc)
	{
		global $database;
		$database = JFactory::getDBO();
		$row = new facileFormsElements($database);
	...
	public static function orderWithoutRedirect($option, $pkg, $form, $page, $positions)
	{
		if(trim($positions) != ''){
	...
	public static function addPageBehind($option, $pkg, $form, $page)
	{
		global $database;
		$database = JFactory::getDBO();
	...
	public static function addPageBefore($option, $pkg, $form, $page)
	{
		global $database;
		$database = JFactory::getDBO();
		$row = new facileFormsForms($database);
	...
	public static function delPage($option, $pkg, $form, $page)
	{
		global $database;
		$database = JFactory::getDBO();
		$row = new facileFormsForms($database);
	...
	public static function getPageDestination($option, $pkg, $form, $page)
	{
		global $database;
		$database = JFactory::getDBO();
		$row = new facileFormsForms($database);
